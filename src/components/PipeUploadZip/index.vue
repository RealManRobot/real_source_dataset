<template>
  <div class="w100">
    <div v-if="type == 1" class="gec6102 mb5 fs12">请上传YOLO格式数据集的压缩包</div>
    <div v-else-if="type == 0" class="gec6102 mb5 fs12">请上传mp4格式的压缩包</div>
    <label v-if="!fileArr.length" @dragover="dropOver" @drop="drop" :for="refId" ref="label" class="rds5 pt20 pb20 tc db" style="border:1px dashed #ccc;">
      <atomSvg type="file" width="48" height="59" color="#666666"></atomSvg>
    ...
    <div v-for="item in fileArr" :key="item.id" class="pt8 pb8 pl30 f ac rds5 mt5" style="background:#F5F7FA;">
...
export default {
  ...
  props: {
    ...
    tmp:  { type: String, default: 'dataset_tmp' }
  },
  emits: ['setFileArr'],
  setup(props, { emit }) {
    return f(props, emit)
